...
public class BootProj10RealtimeDiAutoConfigurationApplication {
	...
	public static void main(String[] args) {
		...
		// get IOC container
		ConfigurableApplicationContext ctx = SpringApplication.run(BootProj10RealtimeDiAutoConfigurationApplication.class, args);

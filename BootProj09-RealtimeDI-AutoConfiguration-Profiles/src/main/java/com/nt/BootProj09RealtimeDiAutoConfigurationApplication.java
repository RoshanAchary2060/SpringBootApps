...
public class BootProj09RealtimeDiAutoConfigurationApplication {
	...
	public static void main(String[] args) {
		...
		// get IOC container
		SpringApplication application = new SpringApplication(BootProj09RealtimeDiAutoConfigurationApplication.class);
